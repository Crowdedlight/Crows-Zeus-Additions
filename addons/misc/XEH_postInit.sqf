...
// zeus modules
private _moduleList = [
    ["Activate On Death",{_this call FUNC(onDeathZeus)}, "\a3\ui_f_curator\data\cfgmarkers\kia_ca.paa"],
    ["Remove Activate On Death",{_this call FUNC(removeOnDeathZeus)}, "\a3\ui_f_curator\data\cfgmarkers\kia_ca.paa"],
